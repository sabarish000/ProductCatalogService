package com.example.product.catalog.exceptions.handlers;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<List<String>> handleMethodValidationException(HandlerMethodValidationException ex) {
